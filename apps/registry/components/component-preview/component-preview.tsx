...
const SIMPLE_PREVIEWS: Record<string, string> = {
  ...
  "canvas-view":
    "Pan-and-zoom canvas surface with keyboard and modified-wheel controls.",
  "completion-dialog":
...
/**
 * Live previews loaded on demand, one chunk per component, so a page
 * downloads the previews it shows. Adding a preview is additive:
...
const PREVIEWS: Record<string, ComponentType> = {
  ...
  "floating-action-button": lazy(
    () => import("./previews/floating-action-button"),
  ),
  form: lazy(() => import("./previews/form")),
  "horizontal-scroll-row": lazy(
    () => import("./previews/horizontal-scroll-row"),
  ),
  ...
  "keyboard-shortcuts-help": lazy(
    () => import("./previews/keyboard-shortcuts-help"),
  ),
