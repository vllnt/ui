...
This is the Web installation track. Choose Native above to switch renderer setup without leaving this page.

Use the published `@vllnt/ui` package or copy individual components from the shadcn-compatible registry.
