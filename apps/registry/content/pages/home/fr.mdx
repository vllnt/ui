...
Remplacez `button.json` par le nom d'un composant du [registre](/components).
...
- Parcourir [les 225 composants](/components)
- Lire la [philosophie](/philosophy) de la bibliotheque
