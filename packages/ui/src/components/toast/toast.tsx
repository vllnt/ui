...
const Toast = React.forwardRef<HTMLDivElement, ToastProps & VariantProps<typeof toastVariants>>(
  ({ className, variant, ...props }, reference) => (
    <div className={cn(toastVariants({ variant }), className)} ref={reference} {...props} />
  ),
)
...
const ToastTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, reference) => (
    <div className={cn('text-sm font-semibold', className)} ref={reference} {...props} />
  ),
)
...
const ToastDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, reference) => (
    <div className={cn('text-sm opacity-90', className)} ref={reference} {...props} />
  ),
)
