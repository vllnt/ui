...
test.describe("AreaChart", () => {
  ...
  test("custom dimensions", async ({ mount }) => {
    const component = await mount(
      <AreaChart data={sampleData} height={200} width={400} />,
    );
    await expect(component).toHaveScreenshot();
  });
  ...
  test("custom color", async ({ mount }) => {
    const component = await mount(
      <AreaChart color="#3b82f6" data={sampleData} />,
    );
    await expect(component).toHaveScreenshot();
  });
});
...
test.describe("BarChart", () => {
  ...
  test("custom dimensions", async ({ mount }) => {
    const component = await mount(
      <BarChart data={sampleData} height={200} width={400} />,
    );
    await expect(component).toHaveScreenshot();
  });
});
...
test.describe("LineChart", () => {
  ...
  test("custom dimensions", async ({ mount }) => {
    const component = await mount(
      <LineChart data={sampleData} height={200} width={400} />,
    );
    await expect(component).toHaveScreenshot();
  });
  ...
  test("custom color", async ({ mount }) => {
    const component = await mount(
      <LineChart color="#3b82f6" data={sampleData} />,
    );
    await expect(component).toHaveScreenshot();
  });
});
