...
describe('CookieConsent', () => {
  ...
  describe('rendering', () => {
    ...
    it('displays default message', () => {
      ...
      const messages = screen.getAllByText('This site uses cookies to improve your experience.')
    ...
    it('displays custom settings text', () => {
      render(<CookieConsent open={true} settingsHref="/privacy" settingsText="Privacy Policy" />)
    ...
    it('shows close button when showCloseButton is true', () => {
      ...
      expect(screen.getByRole('button', { name: 'Close cookie consent' })).toBeInTheDocument()
    })

    it('hides close button by default', () => {
      render(<CookieConsent open={true} />)

      expect(screen.queryByRole('button', { name: 'Close cookie consent' })).not.toBeInTheDocument()
    })
  })
  ...
  describe('interactions', () => {
    ...
    it('calls onDecline when decline button is clicked', () => {
      ...
      render(<CookieConsent declineText="Decline" onDecline={handleDecline} open={true} />)
    ...
    it('calls onOpenChange with false after decline', async () => {
      const handleOpenChange = vi.fn()
      render(<CookieConsent declineText="Decline" onOpenChange={handleOpenChange} open={true} />)
    ...
    it('calls onOpenChange when close button is clicked', async () => {
      const handleOpenChange = vi.fn()
      render(<CookieConsent onOpenChange={handleOpenChange} open={true} showCloseButton={true} />)

      fireEvent.click(screen.getByRole('button', { name: 'Close cookie consent' }))
