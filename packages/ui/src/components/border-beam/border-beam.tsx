...
export const BorderBeam = React.forwardRef<HTMLSpanElement, BorderBeamProps>(
  (
    ...
    const beamStyle: React.CSSProperties = {
      ...
      animationName: "vllnt-border-beam-rotate",
      animationTimingFunction: "linear",
      background: `conic-gradient(from 90deg, transparent 0deg, transparent 220deg, ${colorFrom} 280deg, ${colorTo} 335deg, transparent 360deg)`,
