...
function useScrollFade(containerReference: React.RefObject<HTMLDivElement | null>) {
...
export function Sidebar({ sections }: SidebarProps) {
  ...
  const { showBottomFade, showTopFade } = useScrollFade(scrollContainerReference)
    ...
    <>
      ...
      >
        <div className="relative flex-1 overflow-hidden">
          ...
          <nav className="flex-1 p-4 overflow-y-auto h-full" ref={scrollContainerReference}>
